...
#
# Created: Sat Jul 25 12:16:54 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.minValueHint, 5, 1, 1, 3)
        ...
        self.minValue = QtGui.QDateEdit(Form)
        self.minValue.setEnabled(False)
        self.minValue.setCalendarPopup(True)
        ...
        self.gridLayout.addWidget(self.hasMaxValue, 7, 0, 1, 1)
        self.maxValue = QtGui.QDateEdit(Form)
        self.maxValue.setEnabled(False)
        self.maxValue.setCalendarPopup(True)
        self.maxValue.setObjectName(_fromUtf8("maxValue"))
        self.gridLayout.addWidget(self.maxValue, 7, 1, 1, 3)
        ...
        self.minUseToday = QtGui.QCheckBox(Form)
        self.minUseToday.setObjectName(_fromUtf8("minUseToday"))
        self.gridLayout.addWidget(self.minUseToday, 4, 1, 1, 3)
        self.maxUseToday = QtGui.QCheckBox(Form)
        self.maxUseToday.setObjectName(_fromUtf8("maxUseToday"))
    ...
    def retranslateUi(self, Form):
        ...
        self.hasMinValue.setText(QtGui.QApplication.translate("Form", "Minimum Date", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Form", "Hint", None, QtGui.QApplication.UnicodeUTF8))
        self.hasMaxValue.setText(QtGui.QApplication.translate("Form", "Maximum Date", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.minUseToday.setText(QtGui.QApplication.translate("Form", "Use current respondent date as minimum", None, QtGui.QApplication.UnicodeUTF8))
        self.maxUseToday.setText(QtGui.QApplication.translate("Form", "Use current respondent date as maximum", None, QtGui.QApplication.UnicodeUTF8))
